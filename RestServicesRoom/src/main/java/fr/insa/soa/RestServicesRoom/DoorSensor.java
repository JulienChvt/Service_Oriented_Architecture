...
public class DoorSensor {
	...
	@Path("/{room}")
	@Produces(MediaType.TEXT_PLAIN)
	public String getDoorState(@PathParam("room") String room) throws IOException{
		String url = "http://127.0.0.1:8081/~/mn-cse/mn-name/"+room+"/Door_Sensor/la";
	...
	public String setDoorState(@PathParam("room") String room, @PathParam("state") String state) throws IOException{
