...
public class WindowsSensor {
	...
	String originator = "admin:admin";
	 ...
	 public String hello() {
		 return "Windows sensor";
	 }
	
	@GET
	@Path("/{room}")
	@Produces(MediaType.TEXT_PLAIN)
	public String getWindowsState(@PathParam("room") String room) throws IOException{
		String url = "http://127.0.0.1:8081/~/mn-cse/mn-name/"+room+"/Windows_Sensor/la";
	...
	public String setWindowsState(@PathParam("room") String room, @PathParam("state") String state) throws IOException{
