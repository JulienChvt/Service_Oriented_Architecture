...
public class TempSensorInt {
	...
	@Path("/{room}")
	@Produces(MediaType.TEXT_PLAIN)
	public String getTempInt(@PathParam("room") String room) throws IOException{
		String url = "http://127.0.0.1:8081/~/mn-cse/mn-name/"+room+"/Indoor_Temperature_Sensor/la";
