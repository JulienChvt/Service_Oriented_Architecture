...
public class LightSensor {
	...
	@Path("/{room}")
	@Produces(MediaType.TEXT_PLAIN)
	public String getLightState(@PathParam("room") String room) throws IOException{
		String url = "http://127.0.0.1:8081/~/mn-cse/mn-name/"+room+"/Light_Sensor/la";
	...
	public String setLightState(@PathParam("room") String room, @PathParam("state") String state) throws IOException{
